...
| ------------- | ------------- | ------------- |
| 4 5 3<br>1<br>1<br>0  | 14 | The array is {4, 5, 3}. The index is 1.<br>We remove 5, and we increase all the lower ones and decrease all the higher ones.<br>In this case, there are no higher than 5.<br>The result is {9, 8}.<br>The index is 1. So we remove 8 and decrease all the higher ones.<br>The result is {1}.<br>The index is 0. So we remove 1. <br>There are no elements left, so we print the sum of all removed elements.<br>5 + 8 + 1 = 14.| 
