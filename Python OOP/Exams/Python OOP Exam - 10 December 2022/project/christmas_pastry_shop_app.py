...
pastry_shop = ChristmasPastryShopApp()
pastry_shop.add_delicacy('Gingerbread', 'Gingerbread Man', 2.50)
pastry_shop.add_booth('Open Booth', 1, 5)
pastry_shop.reserve_booth(3)
pastry_shop.order_delicacy(1, 'Gingerbread Man')
pastry_shop.leave_booth(1)
print(pastry_shop.get_income())