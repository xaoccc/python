# Generated by Django 3.2.7 on 2023-10-30 20:36
    ...
    state_operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=deletion.CASCADE, to='main_app.student')),
                ('subject', models.ForeignKey(on_delete=deletion.CASCADE, to='main_app.subject')),
            ],
        ),
...
# We need to add the additional fields from the StudentEnrollment model: "entrollment_date" and "grade".
        migrations.AddField(
            ...
            field=models.DateField(default=datetime_safe.date.today),
        ),
        migrations.AddField(
            model_name='StudentEnrollment',
            name='grade',
